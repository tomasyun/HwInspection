...
abstract class BaseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        (application as YhHwApplication).component
    ...
    fun getViewModelProvider(fragment: Fragment) =
        ViewModelProviders.of(fragment, (application as YhHwApplication).viewModelFactory)

    fun getViewModelProvider(activity: FragmentActivity) =
        ViewModelProviders.of(activity, (application as YhHwApplication).viewModelFactory)
